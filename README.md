...
Ultimately, professional success will depend on the ability to orchestrate quality processes rather than simply executing technical tasks. I was inspired by article https://dl.acm.org/doi/10.1145/3706598.3713819 and popularity. Presented solution is purelly based on LLM content but could easliy extended as a coach with wearable data transforms raw metrics (like steps, heart rate, or sleep cycles). 
...
So in reality this information above in AI era is kind of opely saying YES I CAN  also orchestrate the process as programming is no longer so important.
